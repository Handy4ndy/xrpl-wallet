      ...
      <div className="generate-account">
        {seed ? (
          ...
          <>
            ...
            <p>
                Clicking generate will create a new seed and rAddress, but you&rsquo;ll need to click save to add it to your account and it won&rsquo;t become active until you send it some XRP.
            </p>
